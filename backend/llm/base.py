...
class LLMProvider(ABC):
    ...
    def format_messages_with_context(
        ...
        stable_cap_parts.append(
            ...
            "'Relevant Emails' section. Summarize what you find, highlight "
            "important messages, and answer questions about email content. "
            "Never say you cannot access email -- you CAN.\n\n"
            "**Sending email:** You can send the user an email immediately:\n"
            "```\n"
